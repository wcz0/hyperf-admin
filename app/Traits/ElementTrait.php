...
use App\Admin;
use App\Support\Cores\AdminPipeline;
...
trait ElementTrait
{
     ...
     * 返回列表按钮
     *
     * @return \App\Renderers\OtherAction
     */
     ...
     *
     * @return \App\Renderers\DialogAction|\App\Renderers\LinkAction
     */
     ...
     * @param string $title
     *
     * @return \App\Renderers\DialogAction
     */
     ...
     * @param string            $dialogSize 弹窗大小, 默认: md, 可选值: xs | sm | md | lg | xl | full
     *
     * @return \App\Renderers\Operation
     */
     ...
     * 基础筛选器 - 条件构造器
     *
     * @return \App\Renderers\ConditionBuilderControl
     */
    ...
    /**
     * @return \App\Renderers\CRUDTable
     */
